...
**What you receive**  
Upon purchase, ownlifelab grants you a non-exclusive, non-transferable, revocable license to use the app for personal, non-commercial purposes.

**Multi-device use**  
In accordance with Apple's App Store policies, a single purchase can be used on all devices signed in to the same Apple ID.

**Restrictions**  
You may not:
- Copy, distribute, sell, or sublicense the app or any part of it.
- Attempt to reverse-engineer, decompile, or extract source code from the app.
- Resell or commercially redistribute the app to third parties.

---

## §3 Your Data

All data you enter into the app is yours. ownlifelab claims no rights over your data.

For details on how data is collected, stored, and handled, see the Privacy Policy.
...
ownlifelab may release updates to improve features, fix bugs, and maintain iOS compatibility. Updates are distributed through the App Store and are installed at your discretion.

If an update materially changes these Terms or the Privacy Policy, notice will be provided through the app or in the App Store update description.
...
- Attempting to interfere with or exploit the app's normal operation.
- Infringing any intellectual property rights associated with the app.
...
**Data loss**  
We recommend exporting your data regularly using the app's export function (Settings → Data Sovereignty). ownlifelab is not responsible for data loss resulting from device failure, loss, or deletion of the app.

---

## §8 Termination

**Your right to stop using the app**  
...
These Terms are governed by and construed under the laws of the Republic of Korea. Any dispute arising out of or relating to these Terms will be subject to the exclusive jurisdiction of the Seoul Central District Court as the court of first instance.

Where mandatory consumer protection laws of your country of residence apply, those laws are not affected by this clause.
